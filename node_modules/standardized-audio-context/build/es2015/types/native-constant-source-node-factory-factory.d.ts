...
export declare type TNativeConstantSourceNodeFactoryFactory = (createNativeAudioNode: TNativeAudioNodeFactory, createNativeConstantSourceNodeFaker: TNativeConstantSourceNodeFakerFactory, testAudioScheduledSourceNodeStartMethodNegativeParametersSupport: (nativeContext: TNativeContext) => boolean, testAudioScheduledSourceNodeStopMethodNegativeParametersSupport: (nativeContext: TNativeContext) => boolean, testConstantSourceNodeAccurateSchedulingSupport: (nativeContext: TNativeContext) => boolean, wrapConstantSourceNodeAccurateScheduling: TWrapConstantSourceNodeAccurateSchedulingFunction) => TNativeConstantSourceNodeFactory;
//# sourceMappingURL=/build/es2015/types/native-constant-source-node-factory-factory.d.ts.map