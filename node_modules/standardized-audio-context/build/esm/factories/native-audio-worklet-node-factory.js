...
export var createNativeAudioWorkletNodeFactory = function (createInvalidStateError, createNativeAudioNode, createNativeAudioWorkletNodeFaker, createNotSupportedError) {
            ...
            try {
                ...
                var nativeAudioWorkletNode = createNativeAudioNode(nativeContext, function (ntvCntxt) {
                    return (options.numberOfInputs !== 0 && options.numberOfOutputs === 0) ?
                        new nativeAudioWorkletNodeConstructor(ntvCntxt, name, tslib_1.__assign({}, options, { numberOfOutputs: 1, outputChannelCount: [1], parameterData: tslib_1.__assign({}, options.parameterData, { hasNoOutput: 1 }) })) :
