...
export var createIsSupportedPromise = function (browsernizr, testAudioContextCloseMethodSupport, testAudioContextDecodeAudioDataMethodTypeErrorSupport, testAudioContextOptionsSupport, testChannelMergerNodeSupport, testIsSecureContextSupport) {
    if (browsernizr.promises &&
        ...
        cacheTestResult(testIsSecureContextSupport, function () { return testIsSecureContextSupport(); })) {
        return Promise
            .all([
