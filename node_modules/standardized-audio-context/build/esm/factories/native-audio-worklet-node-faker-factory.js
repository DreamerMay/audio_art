...
export var createNativeAudioWorkletNodeFakerFactory = function (connectMultipleOutputs, createIndexSizeError, createInvalidStateError, createNativeChannelMergerNode, createNativeChannelSplitterNode, createNativeConstantSourceNode, createNativeGainNode, createNativeScriptProcessorNode, createNotSupportedError, disconnectMultipleOutputs) {
    return function (nativeContext, processorDefinition, options) {
        ...
        var numberOfParameters = (processorDefinition.parameterDescriptors === undefined)
            ? 0
        ...
        var parameterMap = new ReadOnlyMap((processorDefinition.parameterDescriptors === undefined)
            ? []
        ...
        var parameters = (processorDefinition.parameterDescriptors === undefined) ?
            [] :
            processorDefinition.parameterDescriptors
